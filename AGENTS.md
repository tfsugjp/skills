...
| [azure-devops-repos](plugins/azure-devops-toolkit/skills/azure-devops-repos/SKILL.md) | Manage Azure Repos pull requests: create, review and vote, manage comment threads, resolve comments, and complete or abandon PRs. Prefers Azure DevOps MCP Server tools and falls back to the REST API. |
